    ...
    <div className="max-w-5xl mx-auto">
      ...
      <div className="mb-6 flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-[#0E121B]">
              {ticket.ticketId}
            </h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          ...
          {ticket.impactLevel && (
            <div className="bg-white rounded-xl border border-[#E1E4EA] p-6">
              <h3 className="text-sm font-semibold text-[#525866] mb-3 flex items-center gap-2">
                <AlertCircle size={16} />
                Impact Level
              </h3>
              <div
          ...
          {/* Metadata */}
          <div className="bg-white rounded-xl border border-[#E1E4EA] p-6">
            <h3 className="text-sm font-semibold text-[#525866] mb-4">
              Details
            </h3>
            <div className="space-y-4">
              <div>
