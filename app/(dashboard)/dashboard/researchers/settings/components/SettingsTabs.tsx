            ...
            {tabs.map((tab) => {
                ...
                return (
                    <button
                        ...
                        className={`flex items-center justify-center gap-[8px] px-[16px] h-full text-[14px] font-semibold transition-colors relative tracking-[-0.02em] ${isActive
                            ? "text-[#FF7A00]"
                    ...
                    >
                        ...
                        {tab.label}
                        {isActive && (
                            <span className="absolute bottom-0 left-0 w-full h-[3px] bg-[#FF7A00]"></span>
                        )}
                    </button>
                );
            })}
