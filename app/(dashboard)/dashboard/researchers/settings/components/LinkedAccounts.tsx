    ...
    <div className="space-y-[32px]">
      ...
      <section>
        <div className="flex items-center gap-[6px] mb-[12px]">
          ...
          <div className="text-[16px] font-medium text-[#0E121B] tracking-[-0.006em]">
            ORCID Integration
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-[#27B973] text-[14px] font-medium">
            Connected
          </div>
        </div>
      </section>
      ...
      <section>
        <div className="flex items-center gap-[6px] mb-[12px]">
          ...
          <button className="ml-auto text-[#007AFF] hover:underline text-[14px] font-medium">
            Unlink
          </button>
        </div>
        <div className="border-b border-[#E1E4EA] mb-[20px]"></div>
        ...
        <div className="space-y-[16px]">
          <div>
            <label className="block text-[14px] font-medium text-[#181B25] mb-[8px]">
              Status
            </label>
