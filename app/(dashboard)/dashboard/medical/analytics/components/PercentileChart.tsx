...
export default function PercentileChart({ analyticsData }: { analyticsData: any }) {
  ...
  return (
    <div
      ref={ref}
      className="bg-white rounded-xl border border-gray-200 p-4 sm:p-6 shadow-sm mb-6 relative overflow-hidden"
    >
      <div className="mb-5 sm:mb-6 pb-4 border-b border-gray-300">
      ...
      <div className="relative h-8 w-full rounded-md overflow-hidden flex text-[8px] sm:text-[10px] md:text-xs font-bold text-white uppercase tracking-wide sm:tracking-wider mb-2">
      ...
      {/* Ticks */}
      <div className="relative h-6 text-[9px] sm:text-[10px] text-gray-400 font-mono mb-4 w-full">
      ...
      <div
        className="absolute top-[82px] sm:top-[88px] transform -translate-x-1/2 flex flex-col items-center z-20 transition-all duration-1000 ease-out"
        style={{ left: `clamp(8px, ${position}%, calc(100% - 8px))` }}
      >
        ...
        {/* Tooltip-like label */}
        <div className="absolute bottom-14 bg-gray-900 text-white text-[11px] sm:text-xs py-1 px-2 rounded whitespace-nowrap shadow-xl">
