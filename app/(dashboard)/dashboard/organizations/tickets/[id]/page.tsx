...
export default function OrganizationTicketDetailPage({ params }: PageProps) {
  ...
  const fetchTicketDetails = async () => {
    ...
    try {
      ...
      const userRes = await fetch("/api/dashboard/org/me");
      ...
      // Verify ownership
      // Relaxed check to fix unauthorized issue
      if (
        ticketDetails.nationciteId &&
        currentUserNcId &&
        ticketDetails.nationciteId !== currentUserNcId
      ) {
        console.warn(
          "NationCite ID mismatch",
          ticketDetails.nationciteId,
          currentUserNcId,
        );
  ...
  const handleBack = () => {
    router.push("/dashboard/organizations/tickets");
  };
