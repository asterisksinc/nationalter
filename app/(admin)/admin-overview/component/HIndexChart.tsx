  ...
  return (
    <div className="col-span-12 lg:col-span-8 p-3 md:p-4 bg-white ">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 sm:gap-0">
        <div className="text-[16px] md:text-[16px] font-semibold md:font-medium leading-[120%] tracking-[-0.006em] text-[#0E121B] ad-chart-header" >
User Growth Trend       
          <p>Daily Active Users (DAU) vs Monthly Active Users (MAU)</p>
 </div>
      </div>
