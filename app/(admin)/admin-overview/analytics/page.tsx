      ...
      <div className="zui-admin-layout min-h-screen">
        ...
        <div className="ad-header-actions">
          ...
          <button className="ad-btn-export">
            ...
            <div
              className="mb-4 md:mb-6 pb-3 md:pb-4 border-b border-[#E1E4EA] -mx-4 md:-mx-6 px-4 md:px-6"
              style={{ display: "flex", justifyContent: "space-between" }}
            >
              <div>
                <div
                  className="text-[18px] md:text-[16px] font-semibold leading-[120%] tracking-[-0.006em] text-[#0E121B]"
                  style={{
                    fontSize: "16px",
                    fontWeight: "600",
                    color: "#0E121B",
                ...
                <p
                  className="text-[13px] md:text-[14px] font-normal leading-[150%] tracking-[-0.02em] text-[#525866] mt-1"
                  style={{
                    fontSize: "12px",
                    fontWeight: "400",
                    color: "#525866",
              ...
              <div className="ad-header-actions">
                ...
                <button className="ad-btn-export">⬇ Export Data</button>
              </div>
            </div>
              ...
              <div className="dg-card">
                <div className="dg-card-header">
                  ...
                  <p className="dg-subtitle">
                    Top performing states by user base
                  </p>
                </div>
