...
export const FileUpload = ({
  ...
  return (
    <div className="w-full">
      ...
      <div className="border-2 border-dashed border-neutral-200 rounded-xl bg-neutral-50 p-5 md:p-4 text-center flex flex-col items-center justify-center cursor-pointer group shadow-none touch-manipulation">
