        ...
        <div className="w-full px-4 md:px-[72px] z-20">
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col items-center text-center mx-auto">
              ...
              {/* Subheading */}
              <p className="text-sm sm:text-base md:text-base lg:text-lg text-[#5C5C5C] pt-4 z-20 mb-10 max-w-xs sm:max-w-sm md:max-w-md lg:max-w-2xl mx-auto text-center">
